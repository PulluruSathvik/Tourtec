...
public class ZoneEntity {
    ...
    public ZoneEntity(String id, String name, double lat, double lng, int capacity, int currentVisitors, String density, String waitTime, String status, int ecoRewardTokens) {
        this.id = id;
        this.name = name;
        this.lat = lat;
        this.lng = lng;
